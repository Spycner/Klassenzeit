...
## Acceptance Criteria
- [ ] Create/update `e2e/.env.example` with API_BASE_URL
- [ ] Update all E2E API test files to use environment variable
- [ ] Pattern: `const API_BASE = process.env.API_BASE_URL || "http://localhost:8080/api";`
