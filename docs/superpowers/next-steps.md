...
**Immediate (UX polish):**
1. **2c: Manual timetable editing** — drag-and-drop lesson editing after generation
2. **2e: Data import/export** — CSV/Excel import for bulk data, PDF/Excel export for timetables
3. **2f: Responsive / mobile layout** — timetable grid on small screens
